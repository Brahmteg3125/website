		...
		<div className="relative">
			...
			<div className="relative min-h-screen flex items-center justify-center overflow-hidden">
				...
				<div className="relative inline-block px-4 sm:px-0">
					...
					<h1 className="relative text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold leading-tight tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-300 pb-6">
						Brahmteg Singh
					</h1>
				</div>
			</div>
			...
			<div className="text-center space-y-6 mt-8">
				<div className="flex flex-col items-center gap-4">
					...
					<p className="text-base sm:text-lg text-gray-400 max-w-2xl px-4 sm:px-0">
						Building the tools of tomorrow. Powered by software, guided by data, and engineered for intelligent autonomy
					</p>
				</div>
